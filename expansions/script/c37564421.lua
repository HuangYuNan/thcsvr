...
function cm.initial_effect(c)
	...
	aux.AddFusionProcFun2(c,function(c) return c:IsFusionSetCard(0x208) end,Senya.check_fusion_set_prism,true)
...
function cm.efcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return r==REASON_XYZ and (rc:IsSetCard(0x208) or Senya.check_set_prism(rc))
end
...
function cm.filter(c)
	return Senya.check_set_prism(c) and c:IsType(TYPE_MONSTER) and c:IsAbleToHand()
end
