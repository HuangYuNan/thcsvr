...
function c210020.initial_effect(c)
	...
	e6:SetDescription(aux.Stringid(210020,5))
	e6:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e6:SetProperty(EFFECT_FLAG_PLAYER_TARGET)
	e6:SetCode(EVENT_SPSUMMON_SUCCESS)
	e6:SetCondition(c210020.skcon2)
	e6:SetTarget(c210020.sktg)
	e6:SetOperation(c210020.skop2)
...
function c210020.skcon2(e,tp,eg,ep,ev,re,r,rp)
	return re and re==e:GetLabelObject() and bit.band(e:GetLabelObject():GetLabel(),TYPE_LINK)~=0
end
function c210020.skop2(e,tp,eg,ep,ev,re,r,rp)
	local e1=Effect.CreateEffect(e:GetHandler())
	e1:SetType(EFFECT_TYPE_FIELD)
	e1:SetProperty(EFFECT_FLAG_PLAYER_TARGET)
	e1:SetTargetRange(0,1)
