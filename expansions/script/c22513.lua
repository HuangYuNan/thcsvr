...
function c22513.lkfilter(c,lc)
	return c:IsFaceup() and c:IsCanBeLinkMaterial(lc) and c:IsType(TYPE_EFFECT) and c:GetAttack()<=1000 and Duel.GetLocationCountFromEx(tp,tp,c,lc)>0
end
