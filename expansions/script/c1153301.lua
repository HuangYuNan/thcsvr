...
function c1153301.con2(e,tp,eg,ep,ev,re,r,rp)
	return re:GetHandler():IsType(TYPE_MONSTER) and Duel.IsPlayerCanDiscardDeck(ep,1) and not re:GetHandler():IsLocation(LOCATION_MZONE)
end
--
...
function c1153301.op2(e,tp,eg,ep,ev,re,r,rp)
	...
	if c1153301.tfilter(tc,ev,re,rp) then
		...
		Duel.Damage(ep,300,REASON_EFFECT)
	end
end
--
